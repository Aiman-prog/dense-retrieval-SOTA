...
echo "   sbatch scripts/launchers/run_inbatch_singularity.sh      # In-batch baseline"
echo "   sbatch scripts/launchers/run_crossbatch_singularity.sh   # Cross-batch (2048)"
echo "   sbatch scripts/launchers/run_ance_singularity.sh         # ANCE iterative"
echo ""
echo "4️⃣  Evaluate trained models:"
echo "   sbatch scripts/launchers/run_evaluate_singularity.sh"
echo ""
